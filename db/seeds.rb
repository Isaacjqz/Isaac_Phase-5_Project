...
user_4 = User.create(first_name:"Grace", last_name:"Hopper", age:"117", email:"grace@tenten.com", zip_code: "10032", user_name:"grace117", password: "test117", current_country:"USA", current_state:"New York", current_city:"NYC", img_url:"https://m.media-amazon.com/images/M/MV5BMTc0MTcxMDAxN15BMl5BanBnXkFtZTgwMjMxODIzNTE@._V1_.jpg")
user_5 = User.create(first_name:"Pablo", last_name:"Fuentes", age:"35", email:"pablo@tenten.com", zip_code: "10032", user_name:"pablo212", password: "test1212", current_country:"USA", current_state:"New York", current_city:"NYC", img_url:"https://ca.slack-edge.com/T02MD9XTF-U042QTA72GP-1867fd3311fe-512")
user_6 = User.create(first_name:"Nasty", last_name:"Nate", age:"205", email:"nasty@tenten.com", zip_code: "10032", user_name:"nasty", password: "test205", current_country:"USA", current_state:"Texas", current_city:"Austin", img_url:"https://ca.slack-edge.com/T02MD9XTF-U044HNJCSAK-12203fb080ef-512")
user_7 = User.create(first_name:"Ryan", last_name:"Fassi", age:"57", email:"ryan@tenten.com", zip_code: "10032", user_name:"ryan57", password: "test57", current_country:"USA", current_state:"Florida", current_city:"Miami", img_url:"https://ca.slack-edge.com/T02MD9XTF-U030LJCFV0X-e59dc03427e3-512")
user_8 = User.create(first_name:"Samuel", last_name:"Gaddis", age:"117", email:"samuel@tenten.com", zip_code: "10032", user_name:"samuel117", password: "test117", current_country:"USA", current_state:"New York", current_city:"NYC", img_url:"https://ca.slack-edge.com/T02MD9XTF-U044HLXBQLF-633a7aa277e8-512")
user_9 = User.create(first_name:"Bruce", last_name:"Lee", age:"35", email:"bruce@tenten.com", zip_code: "10032", user_name:"bruce212", password: "test1212", current_country:"USA", current_state:"California", current_city:"San Francisco", img_url:"https://www.hollywoodreporter.com/wp-content/uploads/2013/02/bruce_lee_a_p.jpg?w=1024")
user_10 = User.create(first_name:"Jack", last_name:"Black", age:"205", email:"jack@tenten.com", zip_code: "10032", user_name:"jack205", password: "test205", current_country:"USA", current_state:"California", current_city:"LA", img_url:"https://www.highsnobiety.com/static-assets/thumbor/62KXekZC09dJYmhdpu78Z7V7yaA=/1600x2401/www.highsnobiety.com/static-assets/wp-content/uploads/2022/08/11143032/jack-black-space-kitten-tee-003.jpg")
